			...
			<div class="row">
				<div class="col-lg-6" style="margin: auto;">
					<div class="login_form_inner register_form_inner">
						...
						<form id="registrform" class="row login_form" method="post" action="create_product_process.php" style="max-width: 450px;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:left;">
                                            <div class="col-md-12 form-group">
                                                <input type="number" name="price_bag" placeholder="請輸入單價">
                                            </div>
                                        </td>
                                    </tr>
